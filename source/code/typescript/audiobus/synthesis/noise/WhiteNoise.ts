...
export default class WhiteNoise
{
  ...
  protected static generate( length:number=1, shape:Function=WhiteNoise.white, sampleRate:number=44100, offline:boolean=false ):AudioBuffer
  {
  ...
  {
    return WhiteNoise.generate( length, WhiteNoise.generateWhite );
  }
